#!/usr/bin/env python3
"""Export one approved still as RGB JPG or PNG and verify its geometry."""
...
def parse_ratio(value: str) -> float:
    try:
        ...
        raise argparse.ArgumentTypeError("Ratio must look like 4:3") from exc
    if ratio <= 0:
