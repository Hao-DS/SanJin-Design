...
Scene and daily anchor: [地点]. The focal subject is [人物/动物/房屋/静物] and is [平静可读的状态或动作]. Explain the place with only [1–3 个生活细节]. Preserve recognizable silhouette, scale, gravity and contact, while simplifying bricks, asphalt, wood grain, foliage, skin pores and interior merchandise into softly painted shapes.

Global color flooding: use [雾青/浅天蓝/水蓝] with [浅粉/蜜桃/淡紫/奶油黄/薄荷] across 75–90% of the entire image, not merely in the sky or reflections. Repaint nominal whites with pink-cyan light, foliage with mint and turquoise, pavement and shadows with blue-lilac, and brown materials with peach-rose. Keep near-black below 3%. Soft does not mean washed out. Preserve a clean cyan field, readable pastel-pink light, pearly spectral highlights and luminous warm skin; avoid gray haze, dirty whites, naturalistic photographic color and a single flat color wash.
...
Avoid: photography, architectural photography, lifestyle photography, real-estate rendering, commercial café imagery, realistic lens effects, photorealistic 3D, realistic brick/asphalt/wood microtexture, natural green-brown-gray palette, large black areas, a normal photo with rainbow reflections added; recreating any supplied reference image or its specific people, houses, fruit arrangements, animals, streets, props or compositions; horror dreamcore, liminal dread, creepy dolls, glitch text, surveillance mood; cyberpunk neon, laser light, futuristic city styling; heavy oil paint, hard vector lines, anime cartooning, toy-like 3D, game-render gloss, HDR; opaque rainbow chrome, dense holographic film, excessive bubbles or sparkles; gray fog, dirty whites, fluorescent or gray skin, blown-out facial detail, random readable text, logos, watermarks.
~~~
